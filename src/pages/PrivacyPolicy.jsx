        ...
        <section className="pb-5 pt-3">
          <div className="container">
            ...
            <h6 className="mb-0">
              ...
              <ul className="privacy">
                <li>
                  Authorized real estate developers for property inquiries
                </li>
                <li>
                  Financial or legal partners (only when required for
                  transaction support)
                </li>
                <li>
              ...
              <p>
                All such parties are obligated to maintain confidentiality and
                use data solely for agreed purposes.
              </p>
              ...
              <ul className="privacy">
                ...
                <li>
                  Deliver relevant advertisements and remarketing campaigns
                </li>
              </ul>
              <p>
              ...
              <p>
                ...
                (developers, partners, portals). We are not responsible for the
