    ...
    <section className="pb-5 pt-3">
      <div className="container">
        <div className="bg-white p-2 p-sm-5 rounded shadow">
          <h2 className="pb-3 text-center text-gradient">Privacy-Policy</h2>
          <hr />
          {/* Header */}
          ...
          {/* Intro */}
          <h4 className="text-gradient">Introduction: Who We Are</h4>
          <p>
            <strong className="fs-5">Jenika Ventures</strong> (“we”, “our”, “us”) respects your
            ...
            submit your details, or interact with us through any online or
            offline channels.
          </p>
          ...
          <p>
            As a real estate channel partner, we may collect the following types
            of information:
          </p>
          ...
          <ul className="privacy">
            ...
            <li>Investment goals (residential / commercial / international)</li>
          </ul>
          ...
          <p>
            ...
            partners, portals). We are not responsible for the privacy practices
